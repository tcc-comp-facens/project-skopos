...
class AgenteAtencaoPrimaria(AgenteCoALA):
    ...
    def propose_actions(self) -> list[dict]:
        ...
        consulta e então consultar despesas (subfunção 301) e
        indicadores (vacinacao).
    ...
    def _act_consultar_despesas(self, action: dict) -> None:
        ...
        Filtra pelas subfunções do plano de consulta (Req 3.2), resolvido
    ...
    def _act_consultar_indicadores(self, action: dict) -> None:
        ...
        Busca os tipos definidos no plano de consulta (Req 3.1),
